...
class PdfService {
  ...
  static Future<Uint8List> generate(PatternData pattern) async {
    ...
    final symbolFont = PdfFont.courier(pdf.document);
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Expanded(
                child: pw.Center(
                  child: isHex
                      ? _buildHexGrid(pattern, drawCellPt, symbolFont)
                      : _buildSquareGrid(pattern, drawCellPt, symbolFont),
                ),
              ),
            ],
          );
  ...
  static pw.Widget _buildSquareGrid(PatternData pattern, double cellPt, PdfFont symbolFont) {
    final rows = pattern.rows;
    final cols = pattern.columns;
  ...
  static pw.Widget _buildHexGrid(PatternData pattern, double cellPt, PdfFont symbolFont) {
    final rows = pattern.rows;
    final cols = pattern.columns;
